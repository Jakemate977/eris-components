...
module.exports = (client) => {
	...
	if (!client || !client instanceof Client)
		throw new Error(
			'INVALID_CLIENT_PROVIDED: The discord.js client is not provided or is invalid...'
		);
...
module.exports.sendAPICallback =
	require('./v12/Classes/APIMessage').sendAPICallback;
...
version === 13
	? (module.exports.CommandInteraction = require('./v13/Classes/CommandInteraction'))
	: null;
