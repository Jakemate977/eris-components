...
exports.isEmoji = exports.resolveType = exports.resolveButton = exports.resolveString = exports.resolveStyle = void 0;
...
function resolveStyle(style) {
    ...
    if (style === 'gray')
        style = 'grey';
    if ((!Constants_1.MessageButtonStyles[style] ||
        Constants_1.MessageButtonStyles[style] === undefined ||
        Constants_1.MessageButtonStyles[style] === null) &&
        (!Constants_1.MessageButtonStylesAliases[style] ||
            Constants_1.MessageButtonStylesAliases[style] === undefined ||
            Constants_1.MessageButtonStylesAliases[style] === null))
        throw new TypeError('INVALID_BUTTON_STYLE: An invalid button styles was provided');
    return typeof style === 'string' ? Constants_1.MessageButtonStyles[style] : style;
}
...
function resolveButton(data) {
    ...
    if (!data.label && !data.emoji)
        throw new TypeError('NO_BUTTON_LABEL_AND_EMOJI: Please provide button label and/or emoji');
    ...
    if (data.emoji &&
        data.emoji.name &&
        this.isEmoji(data.emoji.name) === false)
...
function resolveType(type) {
    return typeof type === 'string' ? Constants_1.MessageComponentTypes[type] : type;
}
