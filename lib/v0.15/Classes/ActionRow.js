...
var MessageComponent_1 = __importDefault(
	require('./interfaces/MessageComponent')
);
var ActionRow = /** @class */ (function (_super) {
	...
	ActionRow.prototype.addComponents = function () {
		...
		(_a = this.components).push.apply(
			_a,
			__spreadArray(
				[],
				__read(
					components.flat(2).map(function (c) {
						return MessageComponent_1.default.create(c, null, true);
					})
				)
			)
		);
