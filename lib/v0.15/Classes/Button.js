...
var ErisButton = /** @class */ (function () {
    function ErisButton(obj) {
        if (obj === void 0) { obj = {}; }
        this.setup(obj);
    }
    ErisButton.prototype.setup = function (obj) {
    ...
    ErisButton.prototype.setStyle = function (style) {
        this.style = Util.resolveStyle(style);
        return this;
    };
    ErisButton.prototype.setLabel = function (label) {
        this.label = Util.resolveString(label);
        return this;
    };
    ErisButton.prototype.setDisabled = function (disabled) {
        this.disabled = disabled;
        return this;
    };
    ErisButton.prototype.setURL = function (url) {
        this.url = Util.resolveString(url);
        return this;
    };
    ErisButton.prototype.setID = function (custom_id) {
        this.custom_id = Util.resolveString(custom_id);
        return this;
    };
    ErisButton.prototype.setEmoji = function (emoji, animated) {
        animated = false;
        if (!emoji)
            return this;
    ...
    ErisButton.prototype.toJSON = function () {
        return {
            type: 2,
            style: this.style,
            label: this.label,
