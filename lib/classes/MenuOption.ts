...
class ErisMenuOption {
    ...
    setup(obj: objMenuOption) {
        ...
        this.value = 'value' in obj && obj.value ? resolveString(obj.value) : null
    ...
    setEmoji(emoji: any, animated?: boolean) {
        ...
        if (!emoji) throw new ErisComponentsError('MISSING_EMOJI_ON_OPTION', 'The setEmoji must use an emoji.')
