import { ErisComponentsError, resolveStyle, resolveString, testEmoji } from '../util'
...
class ErisButton {
    ...
    setup(obj: objButton): this {
        ...
        this.label = ('label' in obj && obj.label) ? resolveString(obj.label) : null
    ...
    setEmoji(emoji: any, animated: boolean): this {
        ...
        if ((animated && typeof (animated) !== 'boolean') || (emoji.animated && typeof (emoji.animated) !== 'boolean')) throw new ErisComponentsError('INVALID_ANIMATED_OPTION', 'The emoji animated option must be true or false (boolean)')
